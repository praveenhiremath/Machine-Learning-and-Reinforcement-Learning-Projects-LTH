...
test_agent = false; %true; % % set to true when you want to test your agent
...
gamm      = 0.99;                                          % Discount factor in Q-learning
...
eps_update_iter    = 700;   % 0: Never update eps, Positive integer k: Update eps every kth episode
