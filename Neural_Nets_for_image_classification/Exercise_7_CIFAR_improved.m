% Exercise 7: CIFAR Dataset
%%
clear;
close all;
addpath('./'); 
%load('./models/cifar10_baseline40k.mat')
load('./models/cifar10_baseline40k_batch50_iters_mu95_2conv_with_32_and_16.mat')
...
saveas(gcf,'Ass3_cifar_conv_layer1_kernels_optimal.png');        
%hold off
...
set(gcf,'Position',[10 1000 1500 1000]);
saveas(gcf,sprintf('Ass3_cifar_E7_Missclassified_images_optimal.png'))
hold off
...
set(gcf,'Position',[10 1000 1500 1000]);
saveas(gcf,sprintf('Ass3_cifar_E7_correctly_classified_images_optimal.png'))
hold off
...
set(gcf,'Position',[10 1000 1500 1000]);
saveas(gcf,sprintf('Ass3_cifar_E7_confusionchart_optimal.png'))
